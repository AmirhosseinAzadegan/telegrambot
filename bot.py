...
# ================ اضافه شده برای Cloudflare Workers ================
from js import Response  # ایمپورت Response مخصوص Workers
import asyncio
# ====================================================================
...
# اعمال تنظیمات SSL (در محیط Workers شاید نیاز نباشد، اما برای امنیت نگه می‌داریم)
...
def get_data_dir():
    # در Cloudflare Workers، فقط می‌توانیم از /tmp استفاده کنیم
    temp_dir = os.path.join(tempfile.gettempdir(), "vpn_bot_data")
    os.makedirs(temp_dir, exist_ok=True)
    print(f"✅ فایل‌ها در {temp_dir} ذخیره می‌شوند (موقت)")
    return temp_dir
...
BACKUP_INTERVAL = 24 * 60 * 60  # این در Workers استفاده نمی‌شود (با Cron جایگزین می‌شود)
...
def start_auto_backup():
    """شروع بکاپ خودکار هر 24 ساعت - در Workers استفاده نمی‌شود (با Cron جایگزین می‌شود)"""
    pass  # غیرفعال شده برای Workers
...
def check_expiry_dates():
    """این تابع در Workers استفاده نمی‌شود. با Cron Trigger جایگزین می‌شود."""
    pass
...
smart_faq = {
    ...
    "قیمت": {
        "keywords": ["قیمت", "قیمت‌ها", "هزینه", "چنده", "قیمتش چنده", "لیست قیمت", "تعرفه"],
        "answer": "💰 **قیمت‌ها:**\n\n"
                  "**🔹 وی‌پی‌ان ویژه (بدون محدودیت کاربر):**\n"
                  "┣ ۱ ماهه ۱۰ گیگ: ۳۰,۰۰۰ تومان\n"
                  "┣ ۱ ماهه ۲۰ گیگ: ۵۰,۰۰۰ تومان\n"
                  "┣ ۱ ماهه ۳۰ گیگ: ۸۰,۰۰۰ تومان\n"
                  "┣ ۱ ماهه ۴۰ گیگ: ۱۰۰,۰۰۰ تومان\n"
                  "┣ ۱ ماهه ۵۰ گیگ: ۱۲۰,۰۰۰ تومان\n"
                  "┣ ۱ ماهه ۸۰ گیگ: ۲۰۰,۰۰۰ تومان\n"
                  "┣ ۱ ماهه ۱۰۰ گیگ: ۲۵۰,۰۰۰ تومان\n"
                  "┣ ۱ ماهه ۱۵۰ گیگ: ۳۱۰,۰۰۰ تومان\n"
                  "┣ ۱ ماهه ۵۰۰ گیگ: ۸۹۰,۰۰۰ تومان\n\n"
                  "┣ ۲ ماهه ۱۰ گیگ: ۵۵,۰۰۰ تومان\n"
                  "┣ ۲ ماهه ۲۰ گیگ: ۷۵,۰۰۰ تومان\n"
                  "┣ ۲ ماهه ۳۰ گیگ: ۱۱۰,۰۰۰ تومان\n"
                  "┣ ۲ ماهه ۴۰ گیگ: ۱۳۰,۰۰۰ تومان\n"
                  "┣ ۲ ماهه ۵۰ گیگ: ۱۵۵,۰۰۰ تومان\n"
                  "┣ ۲ ماهه ۸۰ گیگ: ۲۳۵,۰۰۰ تومان\n"
                  "┣ ۲ ماهه ۱۰۰ گیگ: ۲۷۵,۰۰۰ تومان\n"
                  "┣ ۲ ماهه ۱۵۰ گیگ: ۳۳۵,۰۰۰ تومان\n"
                  "┣ ۲ ماهه ۵۰۰ گیگ: ۱,۷۵۰,۰۰۰ تومان\n\n"
                  "┣ ۳ ماهه ۱۰ گیگ: ۸۵,۰۰۰ تومان\n"
                  "┣ ۳ ماهه ۲۰ گیگ: ۱۲۵,۰۰۰ تومان\n"
                  "┣ ۳ ماهه ۳۰ گیگ: ۱۹۰,۰۰۰ تومان\n"
                  "┣ ۳ ماهه ۴۰ گیگ: ۲۳۰,۰۰۰ تومان\n"
                  "┣ ۳ ماهه ۵۰ گیگ: ۲۷۵,۰۰۰ تومان\n"
                  "┣ ۳ ماهه ۸۰ گیگ: ۴۳۵,۰۰۰ تومان\n"
                  "┣ ۳ ماهه ۱۰۰ گیگ: ۵۲۵,۰۰۰ تومان\n"
                  "┣ ۳ ماهه ۱۵۰ گیگ: ۶۴۵,۰۰۰ تومان\n\n"
                  "**✨ وی‌پی‌ان اختصاصی ترید (ضد شناسایی):**\n"
                  "قیمت‌ها بسته به لوکیشن از ۹۰۰,۰۰۰ تا ۲,۸۵۰,۰۰۰ تومان متغیر است.\n\n"
                  "📌 برای مشاهده دقیق قیمت‌ها، از گزینه '💰 لیست قیمت‌ها' استفاده کنید."
    },
    "مشکل اتصال": {
        "keywords": ["مشکل", "اتصال", "نمیاد", "نمی‌آید", "وصل نمیشه", "قطع", "وصل", "ارور", "error"],
        "answer": "⚠️ **رفع مشکل اتصال:**\n\n"
                  "1. ابتدا مطمئن شو اینترنت فعاله\n"
                  "2. از آپدیت بودن نرم‌افزارت اطمینان حاصل کن\n"
                  "3. پروکسی رو عوض کن\n"
                  "4. اگر از فیلترشکن دیگه‌ای استفاده می‌کنی، خاموشش کن\n"
                  "5. کانفیگ رو مجدداً کپی کن\n"
                  "6. زمان و تاریخ دستگاهت رو با شبکه هماهنگ کن\n\n"
                  "اگر مشکل ادامه داشت، از طریق پشتیبانی پیام بده."
    },
    "تمدید": {
        "keywords": ["تمدید", "تمدید اشتراک", "تمدید کن", "تمدید سرویس", "تمدید کانفیگ"],
        "answer": "🔄 **تمدید اشتراک:**\n\n"
                  "1. از منوی اصلی گزینه '💳 خرید اشتراک' رو بزن\n"
                  "2. نوع و مشخصات قبلیت رو انتخاب کن\n"
                  "3. پس از پرداخت، رسید رو ارسال کن\n\n"
                  "✅ کانفیگ تمدید شده برات ارسال میشه.\n\n"
                  "توجه: تمدید زودهنگام تا ۱۰٪ تخفیف داره!"
    },
    "پرداخت": {
        "keywords": ["پرداخت", "کارت", "واریز", "رسید", "پول", "انتقال وجه"],
        "answer": "💳 **روش پرداخت:**\n\n"
                  "1. مبلغ رو به کارت زیر واریز کن:\n"
                  "   `6037-9917-8950-1234`\n"
                  "   به نام: رضا محمدی - بانک ملت\n"
                  "2. بعد از واریز، رسید رو به ربات ارسال کن\n"
                  "3. پس از تایید ادمین، کانفیگ برات ارسال میشه\n\n"
                  "⏱ زمان تایید: حداکثر ۲ ساعت"
    },
    "امتیاز": {
        "keywords": ["امتیاز", "points", "پوینت", "امتیاز من", "جایزه"],
        "answer": "🏆 **سیستم امتیازات:**\n\n"
                  "• هر خرید = ۲۵ امتیاز\n"
                  "• ۱۰۰ امتیاز = ۱ ماه اشتراک رایگان\n"
                  "• امتیازها همیشه محفوظ می‌مانند\n\n"
                  "🔹 برای دریافت جایزه از منوی '🏆 امتیاز من' اقدام کن"
    },
    "زیرمجموعه": {
        "keywords": ["زیرمجموعه", "رفرال", "referral", "دعوت", "دعوت از دوستان"],
        "answer": "🔗 **سیستم زیرمجموعه‌گیری:**\n\n"
                  "• با هر نفر که از لینک اختصاصی شما عضو بشه، یه زیرمجموعه برات حساب میشه\n"
                  "• با ۵ نفر زیرمجموعه، ۱۰ گیگ کانفیگ رایگان جایزه می‌گیری\n\n"
                  "🔹 برای دریافت لینک، از گزینه '🔗 زیرمجموعه‌گیری' استفاده کن"
    },
    "ترید": {
        "keywords": ["ترید", "اختصاصی", "ضد شناسایی", "ضد بن", "آمریکا", "امارات", "آلمان", "هلند", "فرانسه"],
        "answer": "✨ **وی‌پی‌ان اختصاصی ترید:**\n\n"
                  "مخصوص تریدرها و فریلنسرها با ضمانت ضد شناسایی و ضد بن\n\n"
                  "🔹 ویژگی‌ها:\n"
                  "• ۲۱ لوکیشن مختلف\n"
                  "• حجم نامحدود (به جز امارات ۱۵۰ گیگ)\n"
                  "• کاربران نامحدود\n"
                  "• آی‌پی اختصاصی\n\n"
                  "🔹 برای خرید از منوی '💳 خرید اشتراک' استفاده کن"
    },
    "کد تخفیف": {
        "keywords": ["کد تخفیف", "تخفیف", "discount", "کد"],
        "answer": "🎟️ **کد تخفیف:**\n\n"
                  "اگه کد تخفیف داری، موقع خرید وارد کن تا از تخفیف بهره‌مند بشی.\n\n"
                  "کدهای تخفیف معمولاً در کانال اعلام می‌شن:\n"
                  "@vpnTeo"
    },
    "قطع و وصل": {
        "keywords": ["قطع", "وصل", "قطع/وصل", "قطع کن", "وصل کن", "disconnect"],
        "answer": "🔄 **قطع/وصل کانفیگ:**\n\n"
                  "اگه می‌خوای کانفیگت قطع یا وصل بشه:\n"
                  "1. برو به '📋 اشتراک‌های من'\n"
                  "2. روی اشتراک مورد نظر کلیک کن\n"
                  "3. گزینه '🔄 قطع/وصل' رو بزن\n"
                  "4. نوع درخواستت رو انتخاب کن\n\n"
                  "✅ ادمین در اولین فرصت درخواستت رو انجام میده"
    },
    "کانال": {
        "keywords": ["کانال", "عضویت", "عضو", "join", "channel"],
        "answer": "📢 **کانال ما:**\n\n"
                  "برای اطلاع از آخرین اخبار، تخفیف‌ها و کدهای تخفیف حتما عضو کانال شو:\n"
                  "@vpnTeo\n\n"
                  "بعضی از خریدها نیاز به عضویت در کانال داره."
    },
    "default": {
        ...
        for admin_id in ADMINS:
            try:
                ...
                bot.send_message(admin_id, 
                               f"📬 تیکت جدید از {user_info['full_name']}\n🆔 `{chat_id}`\n📱 {user_info['username']}",
                               reply_markup=markup)
            except:
                pass
    else:
        bot.send_message(chat_id, "❌ نوع پیام پشتیبانی‌شده نیست.")
        return
...
# ================ توابع جدید برای Cloudflare Workers ================
def process_update(body):
    """پردازش آپدیت دریافتی از تلگرام (اجرا در thread جدا)"""
    try:
        update = types.Update.de_json(body)
        bot.process_new_updates([update])
    except Exception as e:
        logging.error(f"خطا در process_update: {e}")

async def fetch(request):
    """نقطه ورود Worker برای دریافت درخواست‌های HTTP (وب‌هوک)"""
    try:
        if request.method == "POST":
            # دریافت بدنه درخواست به صورت JSON
            body = await request.json()
            # اجرای پردازش در thread جدا تا بلاک نشود
            await asyncio.to_thread(process_update, body)
            return Response.new("OK", status=200)
        else:
            return Response.new("Method Not Allowed", status=405)
    except Exception as e:
        logging.error(f"خطا در fetch: {e}")
        return Response.new(f"Error: {e}", status=500)
# ====================================================================

# اگر می‌خواهید ربات را به صورت محلی تست کنید، می‌توانید از این بخش استفاده کنید
# اما در Cloudflare Workers این بخش اجرا نمی‌شود.
if __name__ == "__main__" and os.environ.get("LOCAL_DEV"):
    ...
    # شروع threadها فقط برای تست محلی
